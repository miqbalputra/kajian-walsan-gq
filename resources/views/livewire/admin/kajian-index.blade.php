<div>
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        <div>
            ...
            <p class="text-gray-500">Kelola kegiatan (kajian, rapor, pertemuan) dan presensi</p>
        </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        @empty
            <div class="col-span-full bg-white rounded-2xl shadow-sm border border-gray-100 p-12 text-center">
                ...
                <p class="mt-2 text-gray-500">Belum ada kegiatan</p>
                <button wire:click="openCreateModal"
            ...
            <div class="flex items-center justify-center min-h-screen px-4 py-8">
                ...
                <div class="relative bg-white rounded-2xl shadow-xl max-w-lg w-full p-6 z-10 max-h-[90vh] overflow-y-auto">
                    <div class="flex items-center justify-between mb-6">
                        <h3 class="text-xl font-bold text-gray-900">{{ $editMode ? 'Edit Kegiatan' : 'Buat Kegiatan Baru' }}
                        </h3>
                    ...
                    <form wire:submit="save">
                        <div class="space-y-4">
                            ...
                            <!-- Aturan Presensi (Toggle Switches) -->
                            <div class="bg-gray-50 rounded-xl p-4 space-y-1">
                                ...
                                <label class="flex items-center justify-between py-2 cursor-pointer">
                                    <div>
                                        <span class="text-sm text-gray-700">Hadir Online tersedia</span>
                                        <p class="text-xs text-gray-400">Izinkan presensi online (wajib upload catatan)</p>
                                    </div>
                                    <div class="relative inline-block w-11 h-6">
                                        <input type="checkbox" wire:model="online_enabled" class="sr-only peer">
                                        <div class="w-11 h-6 bg-gray-300 rounded-full peer-checked:bg-primary-500 transition-colors"></div>
                                ...
                                <label class="flex items-center justify-between py-2 cursor-pointer">
                                    <div>
                                        <span class="text-sm text-gray-700">Online wajib upload bukti</span>
                                        <p class="text-xs text-gray-400">Catatan hasil kajian wajib diupload</p>
                                    </div>
                                    <div class="relative inline-block w-11 h-6">
                                        <input type="checkbox" wire:model="online_requires_proof" class="sr-only peer">
                                        <div class="w-11 h-6 bg-gray-300 rounded-full peer-checked:bg-primary-500 transition-colors"></div>
                                        <div class="absolute left-0.5 top-0.5 w-5 h-5 bg-white rounded-full transition-transform peer-checked:translate-x-5 shadow"></div>
                                    </div>
                                </label>
                                ...
                                <label class="flex items-center justify-between py-2 cursor-pointer">
                                    <div>
                                        <span class="text-sm text-gray-700">Izin wajib upload surat</span>
                                        <p class="text-xs text-gray-400">Surat/keterangan izin harus diupload</p>
                                    </div>
                                    <div class="relative inline-block w-11 h-6">
                                        <input type="checkbox" wire:model="izin_requires_proof" class="sr-only peer">
                                        <div class="w-11 h-6 bg-gray-300 rounded-full peer-checked:bg-primary-500 transition-colors"></div>
                                        <div class="absolute left-0.5 top-0.5 w-5 h-5 bg-white rounded-full transition-transform peer-checked:translate-x-5 shadow"></div>
                                    </div>
                                </label>
                                ...
                                <label class="flex items-center justify-between py-2 cursor-pointer">
                                    <div>
                                        <span class="text-sm text-gray-700">Izin wajib ada catatan alasan</span>
                                        <p class="text-xs text-gray-400">Wali harus menulis alasan izin</p>
                                    </div>
                                    <div class="relative inline-block w-11 h-6">
                                        <input type="checkbox" wire:model="izin_requires_notes" class="sr-only peer">
                                        <div class="w-11 h-6 bg-gray-300 rounded-full peer-checked:bg-primary-500 transition-colors"></div>
                                        <div class="absolute left-0.5 top-0.5 w-5 h-5 bg-white rounded-full transition-transform peer-checked:translate-x-5 shadow"></div>
                                    </div>
                                </label>

                                <!-- Guru hadir wajib catatan -->
                                <label class="flex items-center justify-between py-2 cursor-pointer">
                                    <div>
                                        <span class="text-sm text-gray-700">Guru hadir fisik wajib catatan</span>
                                        <p class="text-xs text-gray-400">Guru yang scan QR wajib upload catatan kajian</p>
                                    </div>
                                    <div class="relative inline-block w-11 h-6">
                                        <input type="checkbox" wire:model="guru_hadir_fisik_requires_proof" class="sr-only peer">
                                        <div class="w-11 h-6 bg-gray-300 rounded-full peer-checked:bg-primary-500 transition-colors"></div>
                                        <div class="absolute left-0.5 top-0.5 w-5 h-5 bg-white rounded-full transition-transform peer-checked:translate-x-5 shadow"></div>
                                    </div>
                                </label>
                                ...
                                <label class="flex items-center justify-between py-2 cursor-pointer">
                                    <div>
                                        <span class="text-sm text-gray-700">AI Review bukti otomatis</span>
                                        <p class="text-xs text-gray-400">AI otomatis cek foto bukti yang diupload</p>
                                    </div>
                                    <div class="relative inline-block w-11 h-6">
                                        <input type="checkbox" wire:model="ai_review" class="sr-only peer">
                                        <div class="w-11 h-6 bg-gray-300 rounded-full peer-checked:bg-primary-500 transition-colors"></div>
                                        <div class="absolute left-0.5 top-0.5 w-5 h-5 bg-white rounded-full transition-transform peer-checked:translate-x-5 shadow"></div>
                                    </div>
                                </label>
