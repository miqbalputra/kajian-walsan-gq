        ...
        <div class="flex flex-col sm:flex-row gap-4">
            <div class="flex-1">
                <div class="relative">
                    ...
                    <input type="text" wire:model.live.debounce.300ms="search" placeholder="Cari nama, username, atau email..."
                                    ...
                                    <div class="relative overflow-hidden rounded-xl shadow-lg border border-slate-200 bg-white mx-auto flex flex-col"
                                        ...
                                        <div
                                            ...
                                            <div class="flex items-center gap-1.5">
                                                ...
                                                <p class="text-white font-black text-[8px] tracking-tight uppercase">Kajian Walsan
                                                </p>
                                            </div>
                                        </div>
