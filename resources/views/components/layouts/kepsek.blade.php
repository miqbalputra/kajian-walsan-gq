...
<head>
    ...
    <title>{{ $title ?? 'Kepala Sekolah' }} - Presensi Wali Santri</title>
        ...
        <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
            ...
            <nav class="p-4 space-y-1">
                ...
                <a href="{{ route('kepsek.surveys.index') }}"
                    class="flex items-center gap-3 px-4 py-3 rounded-xl font-medium transition-colors {{ request()->routeIs('kepsek.surveys.*') ? 'bg-primary-50 dark:bg-primary-900/20 text-primary-600 dark:text-primary-400' : 'text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-slate-800' }}">
